...
var Engine = (function(global) {
    ...
    // To render the score, gem, heart and alert window if you win or loose.
    function renderScore() {
        ...
        var text = "Score: " + totalScore +
            "    " + "Lives: " + totalHeart;
        ctx.fillText(text, 18, 80);

        if (playerBeginY && totalScore >= 30) {
            alert("CONGRATUALIONS YOU WON!");
            document.location.reload();

        }
        if (playerBeginY && totalHeart < 0 || playerBeginY && totalScore < 0) {
            alert("GAME OVER");
            document.location.reload();
